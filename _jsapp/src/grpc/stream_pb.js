...
goog.exportSymbol('proto.stream.StreamPayload.Event', null, global);
...
proto.stream.StreamPayload.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.stream.StreamPayload.Event} */ (reader.readEnum());
      msg.setEvent(value);
      break;
    case 2:
 ...
 * @enum {number}
 */
proto.stream.StreamPayload.Event = {
  NEW: 0,
  MOD: 1,
  DELETE: 2
};
 ...
 * @return {!proto.stream.StreamPayload.Event}
 */
proto.stream.StreamPayload.prototype.getEvent = function() {
  return /** @type {!proto.stream.StreamPayload.Event} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
