...
func (m *ObjectPosition) Reset()                    { *m = ObjectPosition{} }
func (m *ObjectPosition) String() string            { return proto.CompactTextString(m) }
func (*ObjectPosition) ProtoMessage()               {}
func (*ObjectPosition) Descriptor() ([]byte, []int) { return fileDescriptorEntity, []int{8} }
...
func init() {
	...
	proto.RegisterType((*ObjectPosition)(nil), "entity.ObjectPosition")
...
type EntityServiceClient interface {
	CreateEntity(ctx context.Context, in *ObjectPosition, opts ...grpc.CallOption) (*Activity, error)
...
func (c *entityServiceClient) CreateEntity(ctx context.Context, in *ObjectPosition, opts ...grpc.CallOption) (*Activity, error) {
	out := new(Activity)
...
type EntityServiceServer interface {
	CreateEntity(context.Context, *ObjectPosition) (*Activity, error)
...
func _EntityService_CreateEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EntityServiceServer).CreateEntity(ctx, req.(*ObjectPosition))
	}
...
func (m *ObjectPosition) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ObjectPosition) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ObjectPosition) Size() (n int) {
	var l int
	_ = l
	l = len(m.ObjectId)
	if l > 0 {
...
func (m *ObjectPosition) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ObjectPosition: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ObjectPosition: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorEntity = []byte{
	...
	,
}
